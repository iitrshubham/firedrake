...
@pytest.mark.parallel(nprocs=3)
@pytest.mark.parametrize('cell_family_degree_dim', [("triangle", "P", 4, 3, "BDMF", 3, "DG", 2, 2),
...
@pytest.mark.parametrize('cell_family_degree_vfamily_vdegree', [("triangle", "BDMF", 3, "DG", 3),
                                                                ("quadrilateral", "RTCF", 3, "DG", 3)])
